...
class DiscoverService extends _$DiscoverService {
  ...
  Future<TopHashtagVideos> getVideosofTopHashtags() async {
    var response = await dio.get('hashtag/top-hashtags-videos');
    print(topHashtagVideosFromMap(jsonEncode(response.data)));
    return topHashtagVideosFromMap(jsonEncode(response.data));
  }

  @override
  FutureOr<TopHashtagVideos> build() {
